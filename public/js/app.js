...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_the_mask__ = __webpack_require__(64);
...
var app = new Vue({
    ...
    methods: {
        makeRequest: function makeRequest() {
            ...
            axios.post('/api/request', this.request).then(function () {}.bind(this));
        }
    }
});
...
newMarker = function newMarker(latLng, map) {
